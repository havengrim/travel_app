      ...
      <div className=' flex max-container padding-container relative w-full justify-end'>
        ...
        <div className='z-20 flex w-full flex-col lg:w-[60%]'>
          <div className='relative'>
            <Image src="/camp.svg" alt="camp" width={50} height={50} className='absoulte left-[-5px] top-[-28px] w-10 lg:w-[50px]' />
            <h2 className='bold-40 lg:bold-64'>Our Features</h2>
          </div>
          <ul className='mt-10 grid grap-10 md:grid-cols-2 lg:mt-20 lg:gap-20 '>
